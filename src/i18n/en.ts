...
export const en: Translations = {
  ...
  landing: {
    ...
    faq: {
      ...
      a1: 'Yes, permanently private. There is no reveal phase. The coordinator decrypts messages during tallying, but individual vote choices are never published. Only aggregate results (total For/Against) are made public.',
