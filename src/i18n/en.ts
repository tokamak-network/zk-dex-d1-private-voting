...
export const en: Translations = {
  ...
  landing: {
    ...
    faq: {
      ...
      a4: 'The codebase is fully open source (MIT license) with 310+ automated tests and 7 cryptographic security properties verified. Built on Ethereum PSE MACI research. Community audit and formal audit are planned before mainnet.',
