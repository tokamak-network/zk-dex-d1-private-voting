...
export const en: Translations = {
  ...
  landing: {
    ...
    features: {
      ...
      fairness: { title: 'Whale-Resistant', sub: '', desc: 'Quadratic voting makes each additional unit of influence exponentially more expensive.' },
    ...
    demo: {
      ...
      subtitle: 'Watch the full voting flow — from wallet connection to on-chain verified results. Every step is encrypted, every tally is provable.',
      placeholder: 'Demo Video Coming Soon',
      note: 'Full walkthrough: Connect → Vote → Key Change → Tally → Verify',
    },
    comparison: {
