...
export const en: Translations = {
  ...
  landing: {
    ...
    title: 'Your Vote.\nYour Secret.',
    subtitle: 'DAO votes are public. Whales dominate. Bribes happen. SIGIL keeps votes private, makes bribery useless, and makes influence fair.',
    enterApp: 'Launch App',
    ...
    features: {
      privacy: { title: 'Permanent Privacy', sub: '', desc: 'Your vote is encrypted and never revealed — even after voting ends.' },
      coercion: { title: 'Bribe-Proof', sub: '', desc: 'Change your voting key and re-vote. A briber can\'t prove what you did.' },
      fairness: { title: 'Whale-Resistant', sub: '', desc: 'Quadratic voting makes extra influence expensive. Casting 10 votes costs 100 credits.' },
      verified: { title: 'On-chain Verified', sub: '', desc: 'ZK proofs are published on-chain. Anyone can verify the tally.' },
    },
    operationalFlow: 'How Privacy Is Guaranteed',
    lifecycle: {
      title: 'Three Layers of Protection',
      label: 'Three Security Layers',
      step1: { title: 'Encryption', desc: 'Your vote is encrypted in your browser before it goes on-chain. On-chain data is unreadable without the secret key.' },
      step2: { title: 'Anti-Bribery', desc: 'If coerced, change your voting key and re-vote. Key-change messages look the same as vote messages.' },
      step3: { title: 'Verified Tally', desc: 'The coordinator tallies votes and must publish a ZK proof. Any manipulation fails verification.' },
    },
    ...
    integration: {
      title: 'Integrate in\nMinutes',
      subtitle: 'Add private, coercion-resistant voting to your DAO with a lightweight SDK. No backend required.',
      step1Title: 'Get SDK',
      step1Code: 'sigil-sdk (packaging in progress)',
      step1Desc: 'Packaging is in progress. Ask for early access if you need it now.',
    ...
    stats: {
      testsCount: '3',
      testsLabel: 'Core Layers',
      contractsCount: 'Testnet',
      contractsLabel: 'Status',
      propertiesCount: '7',
    ...
    advantages: {
      ...
      delegation: { title: 'Vote Delegation', desc: 'Delegate voting power to a trusted address if you can’t vote directly.' },
      execution: { title: 'On-chain Execution', desc: 'Optionally execute a contract action after a vote passes, with a timelock.' },
    },
    faq: {
      ...
      a2: 'Currently free on Sepolia testnet. On Ethereum mainnet, verification costs depend on batch size and network conditions. Voters pay gas per vote transaction. On L2 networks (Base, Arbitrum), costs are typically lower than L1.',
      ...
      a4: 'The codebase is fully open source (MIT license) with automated tests and 7 cryptographic security properties aligned to MACI. Built on Ethereum PSE MACI research. Community audit and formal audit are planned before mainnet.',
  ...
  tallying: {
    ...
    overdueDesc: 'This poll is still being processed. Results will appear automatically once the coordinator finishes merging, proving, and tallying.',
    overdueHint: 'If you control the coordinator, run: cd coordinator && npx tsx src/cron.ts',
  ...
  technology: {
    ...
    zkVoting: {
      ...
      desc: 'Votes are sealed with Poseidon commitments and verified by Groth16 proofs. Each vote is encrypted client-side, stored on-chain as ciphertext, and tallied with ZK proofs — without any reveal phase. Individual votes remain permanently private.',
    ...
    infrastructure: {
      ...
      delegation: { title: 'Delegation Registry', desc: 'Optional delegation allows a trusted address to vote with combined voting power. Delegators are tracked on-chain and can revoke at any time.' },
      execution: { title: 'Timelocked Execution', desc: 'Proposals can include an optional on-chain execution step. After a successful vote and timelock, a registered call can be executed automatically.' },
    },
    cta: {
